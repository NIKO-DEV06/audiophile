...
const ItemsSection = () => {
  return (
    <section className="flex flex-col gap-[1.5rem] py-[5rem]">
      <div className="relative bg-[#D87D4A] mx-7 md:mx-14 text-white rounded-xl flex flex-col items-center justify-center pb-[4rem] md:pb-[5rem] pt-[6rem] gap-[0.5rem] md:gap-[1rem] overflow-hidden">
        <Image
          src={pattern}
          alt="pattern"
        ...
        <p className="text-center lg:text-left text-[1.1rem] mdtext-[1rem] font-[500] opacity-70 mx-[3.5rem] lg:mx-0 mt-[0.8rem] lg:font-[400] lg:tracking-wide lg:leading-[1.8rem] z-10 md:w-[20rem]">
      ...
      <div className="flex flex-col md:flex-row md:justify-between gap-[1.5rem] md:mx-14">
