  ...
  return (
    <section className="flex flex-col gap-[1.5rem]">
      <div className="relative bg-[#D87D4A] mx-7 text-white rounded-xl flex flex-col items-center justify-center pb-[4rem] pt-[6rem] gap-[0.5rem] overflow-hidden">
        ...
        <h1 className="text-[2.5rem] md:text-[4rem] text-center lg:text-left leading-[3.5rem] md:leading-[4.2rem] font-bold lg:font-semibold lg:tracking-wider uppercase mt-[2.5rem] z-10">
          ZX9 <br /> SPEAKER
        </h1>
      ...
      <div className="mx-7">
        <div className="imgSpeaker bg-center bg-no-repeat bg-cover h-[320px] rounded-xl">
          <div className="">
            <h1 className="text-[2rem] md:text-[4rem] text-left font-bold lg:font-semibold lg:tracking-wider uppercase pt[5rem] z-10">
              ZX7 SPEAKER
            </h1>
            <Button
